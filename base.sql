...
('Analamanga'), ('Atsinanana'), ('Boeny'), ('Haute Matsiatra'), 
('Vakinankaratra'), ('Diana'), ('Sava'), ('Itasy');

INSERT INTO BNGRC_villes (nom, id_region) VALUES
('Antananarivo Renivohitra', 1), ('Ambohidratrimo', 1), ('Anjozorobe', 1), ('Manjakandriana', 1),
('Toamasina I', 2), ('Brickaville', 2), ('Vatomandry', 2), ('Mahanoro', 2),
('Mahajanga I', 3), ('Marovoay', 3), ('Ambato-Boeny', 3), ('Mitsinjo', 3),
('Fianarantsoa I', 4), ('Ambohimahasoa', 4), ('Ikalamavony', 4),
('Antsirabe I', 5), ('Betafo', 5), ('Ambatolampy', 5),
('Antsiranana I', 6), ('Ambilobe', 6), ('Nosy Be', 6);
...
('Riz', 1000, '2026-02-09'), ('Huile', 200, '2026-02-09'), ('Tôle', 150, '2026-02-09'),
('Riz', 1500, '2026-02-10'), ('Huile', 300, '2026-02-10'), ('Tôle', 200, '2026-02-10'),
('Argent', 2000000, '2026-02-10'), ('Riz', 800, '2026-02-11'), ('Haricot', 250, '2026-02-11'),
('Bâche', 120, '2026-02-11'), ('Ciment', 100, '2026-02-11'), ('Tôle', 300, '2026-02-12'),
('Sucre', 200, '2026-02-12'), ('Argent', 1500000, '2026-02-12'), ('Clou', 80, '2026-02-12'),
('Riz', 600, '2026-02-13'), ('Farine', 400, '2026-02-13'), ('Couverture', 300, '2026-02-13'),
('Savon', 150, '2026-02-13'), ('Eau', 500, '2026-02-14'), ('Médicaments', 30, '2026-02-14'),
('Argent', 800000, '2026-02-14'), ('Vêtements', 250, '2026-02-14'), ('Riz', 700, '2026-02-15'),
('Lait', 200, '2026-02-15'), ('Moustiquaire', 100, '2026-02-15'), ('Mais', 200, '2026-02-10');
...
(1, 8, 500, 'complete', '2026-02-10 10:30:01'),
(4, 2, 150, 'partiel', '2026-02-11 09:15:00'),
(5, 3, 200, 'partiel', '2026-02-11 09:15:01'),
(10, 9, 80, 'en_cours', '2026-02-12 14:20:00');
