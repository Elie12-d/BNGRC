      ...
      <div class="card-body p-4">
        <form action="/besoin/save" method="POST">
          <div class="row g-4">
            ...
            <div class="col-md-6">
              <label class="form-label fw-semibold text-secondary">
                <i class="fa-solid fa-box me-1 text-primary"></i> Nature du besoin
                <span class="text-danger">*</span>
              </label>
              <?php if (!empty($products)): ?>
                <select name="nom" class="form-select form-select-lg rounded-3 border-2" required>
              ...
              <?php else: ?>
                <input type="text" name="nom" class="form-control form-control-lg rounded-3 border-2"
                       required placeholder="Ex: Riz, Tôle, Ciment"/>
              <?php endif; ?>
            </div>
