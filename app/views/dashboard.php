...
<body>
    ...
    <div class="main">
        ...
        <header class="topbar">
            ...
            <div class="topbar-actions">
                ...
                <select name="" id="methodeDispatch" class="filter-select">
                    <option value="auto-by-demande">Par ordre de demande</option>
                    <option value="auto-by-quantity">Par quantite</option>
                    <option value="auto-proportional">Par proportionnalite</option>
                </select>

                <a href="<?= BASE_URL ?>/dispatch/auto-by-demande" id="dispatchLink" class="btn btn-primary">
                    <i class="fa-solid fa-wand-magic-sparkles"></i> Dispatch
                </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const select = document.getElementById('methodeDispatch');
            const dispatchLink = document.getElementById('dispatchLink');
            select.addEventListener('change', function() {
                const baseUrl = '<?= BASE_URL ?>';
                const valeur = this.value;
                dispatchLink.href = baseUrl + '/dispatch/' + valeur;
                console.log('Méthode de dispatch sélectionnée : ' + baseUrl + '/dispatch/' + valeur);
            });
        });
    </script>
</body>
